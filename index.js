import{i as a,S as h}from"./assets/vendor-BrddEoy-.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function s(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(e){if(e.ep)return;e.ep=!0;const i=s(e);fetch(e.href,i)}})();const p=o=>{const r="47345226-0bb2374200c7482689dd59086",s=new URLSearchParams({key:r,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0});return fetch(`https://pixabay.com/api/?${s}`).then(t=>{if(!t.ok)throw new Error(t.status);return t.json()}).then(t=>t.hits)},d=o=>o.map(({webformatURL:r,largeImageURL:s,tags:t,likes:e,views:i,comments:c,downloads:g})=>`
    ...
    `).join(""),l="data:image/png;base64,",u=document.querySelector(".form"),n=document.querySelector(".gallery"),m=document.querySelector(".loader");u.addEventListener("submit",A);function A(o){o.preventDefault(),n.innerHTML="";let r=o.target.elements.name;const s=r.value.trim();if(!s){a.show({title:"",iconUrl:`${l}`,backgroundColor:"red",messageColor:"white",message:"Enter the data for the search!",position:"topRight"});return}p(s).then(t=>{t.length===0&&a.show({title:"",iconUrl:`${l}`,backgroundColor:"red",messageColor:"white",message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"}),m.style.display="inline-block",n.insertAdjacentHTML("beforeend",d(t)),new h(".gallery a",{captionsData:"alt",captionDelay:250}).refresh(),r.value="",m.style.display="none"}).catch(t=>console.log(t))}
